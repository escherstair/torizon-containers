...
DOCKER_RUN_IMX95="docker container run -d -it --net=host --name=qt6-wayland-examples \
             --cap-add CAP_SYS_TTY_CONFIG -v /dev:/dev -v /tmp:/tmp -v /run/udev/:/run/udev/ \
             --device-cgroup-rule='c 4:* rmw'  --device-cgroup-rule='c 13:* rmw' \
             --device-cgroup-rule='c 226:* rmw' --device-cgroup-rule='c 29:* rmw' --device-cgroup-rule='c 199:* rmw' \
             $REGISTRY/torizon/qt6-wayland-examples-imx95:stable-rc"
...
teardown_file() {
  cleanup_container qt6-wayland-examples
}
